 ...
 * @version 1.0
 */
public class AuthServerGenerator {
    ...
    private static String PACKAGE_NAME = "com.ws.springcloud.auth.server";
    ...
    private static String getProjectPath(String packageName) {
        String tmp = AuthServerGenerator.class.getResource("").getPath();
